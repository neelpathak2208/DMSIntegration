...
public class DownloadResource {
    ...
    /**
     * Retrieves representation of an instance of com.indigo.dmsintegration.services.DownloadResource
    ...
    /**
     * PUT method for updating or creating an instance of DownloadResource
    ...
    public String putJson(String content, @HeaderParam("authorization") String authString) {
        ...
        try {
            bp.downloadDocument(content);
        } catch (Exception ex) {
             LogProcessing.errorLogs.info("Exception in download putJson call: "+ex);
             
        }
        return new jsonResponse().downloadJsonResponse();
